          ...
          <div className="container mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                View my therapy session rates and available services.
              </p>
            </div>
            
            <div className="prose prose-lg max-w-4xl mx-auto">
              <p>
                Fees page content coming soon. This page will include information about session rates,
                insurance coverage, payment options, and cancellation policies.
              </p>
