...
const Hero = () => {
  ...
  return <div className="relative h-screen overflow-hidden bg-slate-700">
      ...
      <div className="relative z-10 container mx-auto px-6 h-full flex flex-col justify-center">
        <div ref={heroRef} className="max-w-xl transition-all duration-1000 transform opacity-0 translate-y-10 relative">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-medium text-white leading-tight mb-8 tracking-wide" style={{
          ...
          <p className="text-xl text-white/90 mb-10 font-normal max-w-lg" style={{
          ...
          <div className="bg-white/15 backdrop-blur-md p-5 rounded-lg max-w-md mb-10 border border-white/10 shadow-lg">
            <p className="text-white/95 text-sm leading-relaxed font-light">Start Today with a Free Consultation – A Better Tomorrow Awaits</p>
          </div>
          
          {/* CTA button with enhanced visibility */}
          <Link to="/contact" className="inline-block bg-white text-slate-800 hover:bg-white/90 transition-colors py-3 px-8 rounded-full font-normal shadow-md hover:shadow-lg">
            Begin Your Journey
          </Link>
        </div>
      </div>
