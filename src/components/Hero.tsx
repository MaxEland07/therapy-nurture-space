...
const Hero = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center pt-24 overflow-hidden">
      ...
      <div 
        ref={heroRef}
        className="container mx-auto px-6 py-20 relative z-10 transition-all duration-1000 transform opacity-0 translate-y-10 mt-12"
      >
        <div className="max-w-3xl">
          <span className="inline-block py-1 px-3 bg-primary/10 backdrop-blur-sm text-primary rounded-full font-medium mb-6 text-sm animate-fade-in uppercase">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Button asChild className="bg-therapy-blue text-white hover:bg-therapy-blue/90 text-base">
              <Link to="/contact">Start Today with a Free Consultation</Link>
            </Button>
            <Button asChild variant="outline" className="border-therapy-blue text-therapy-blue hover:bg-therapy-blue/10 text-base">
              <Link to="/expertise">Learn More</Link>
            </Button>
          </div>
          
          <div className="mt-10 py-2 px-4 bg-therapy-blue/10 backdrop-blur-sm inline-block rounded-lg">
            <p className="text-therapy-blue">A Better Tomorrow Awaits</p>
          </div>
        </div>
      </div>
