...
const Hero = () => {
  ...
  return <section aria-label="Mental Health Therapy Services" className="relative h-screen overflow-hidden">
      ...
      <div className="hidden lg:block h-full w-full">
        ...
        <div className="absolute inset-y-0 left-0 w-1/2 z-10 bg-gradient-to-r from-slate-50 to-slate-100/90">
          <div className="h-full flex flex-col justify-center px-16 py-10">
            <div className={`max-w-2xl transition-all duration-700 ${isLoaded ? 'opacity-100' : 'opacity-0 translate-y-4'}`}>
              {/* Credential badge */}
              <div className="mb-12">
              ...
              <div className="mt-6">
                <Link to="/contact" className="inline-block bg-white border-2 border-slate-800 text-slate-800 hover:bg-slate-800 hover:text-white transition-colors duration-300 px-10 py-3 uppercase font-semibold tracking-wider text-base shadow-sm rounded-md">
                  Let's Do This!
                </Link>
              </div>
            </div>
        ...
        <div className="absolute inset-y-0 right-0 w-1/2">
          ...
          }} role="img" aria-label="Person overlooking ocean, representing mental health journey" />
      ...
      <div className="lg:hidden h-full w-full">
        ...
        {/* Mobile content area */}
        <div className={`relative z-10 h-full flex flex-col justify-end pb-12 px-6 transition-all duration-700 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
          ...
          <div className="flex justify-center"> {/* Center the button */}
            <Link to="/contact" className="inline-block bg-white text-slate-800 px-10 py-3 uppercase font-semibold tracking-wider text-sm shadow-md rounded-md mx-auto max-w-xs">
              Let's Do This!
            </Link>
          </div>
        </div>
